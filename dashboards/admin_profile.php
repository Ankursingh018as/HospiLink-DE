    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="admin_dashboard.php#overview" class="nav-item">
                ...
                <a href="admin_dashboard.php#activity" class="nav-item">
                        ...
                        <form id="profileForm" class="profile-form">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="age" name="age" value="" placeholder="Enter age" min="1" max="120">
                                </div>
